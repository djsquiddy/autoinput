 ...
 * @date August 2026
 */
#ifndef INCLUDE_AUTOINPUT_SUPPORT_TYPES_H
#define INCLUDE_AUTOINPUT_SUPPORT_TYPES_H
#pragma once
...
namespace autoinput
{
    ...
    /**
     * @brief Information about an application window.
     */
    ...
    /**
     * @brief Platform-specific keyboard event data wrapper.
     */
    struct KeyboardData
    {
        std::any internal;
    ...
    /**
     * @brief Platform-specific mouse event data wrapper.
     */
    struct MouseData
    {
        std::any internal;
    ...
    /**
     * @brief Template for hash functions used in unordered containers.
    ...
    /**
     * @brief Helper for formatting strings with quotes and escaping.
     */
    struct Quoted
    {
        /**
         * @brief Constructs a Quoted helper.
         * @param str The string view to quote.
         */
    ...
    /**
     * @brief The state of an automation action (e.g. click vs hold).
     */
    ...
    /**
     * @brief Represents a mouse button with optional key modifiers.
     */
    struct Mouse
    {
        /**
         ...
         * @param rhs The other Mouse object to compare with.
    ...
    /**
     * @brief Represents the state of a key at the platform level.
     */
    struct KeyState
    {
    ...
    /**
     * @brief Represents a keyboard key with optional modifiers.
     */
    struct Key
    {
        /** @brief The character or key name (e.g. "a", "enter"). */
        std::string character{};
        /** @brief The key modifier mask. */
        KeyModifier modifier{ KeyModifier::None };
        ...
        /**
         * @brief Equality operator.
         * @param rhs The other Key object to compare with.
         * @return True if they are identical.
         */
...
#endif // INCLUDE_AUTOINPUT_SUPPORT_TYPES_H
