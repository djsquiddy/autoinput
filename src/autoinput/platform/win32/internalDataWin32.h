 ...
 * @date August 2026
 */
#ifndef INCLUDE_AUTOINPUT_PLATFORM_INTERNAL_DATA_WIN32_H
#define INCLUDE_AUTOINPUT_PLATFORM_INTERNAL_DATA_WIN32_H
#pragma once
...
#endif // INCLUDE_AUTOINPUT_PLATFORM_INTERNAL_DATA_WIN32_H
