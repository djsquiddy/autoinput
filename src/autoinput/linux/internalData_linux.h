 ...
 * @date July 2026
 */
#ifndef INCLUDE_AUTOINPUT_LINUX_INTERNAL_DATA_LINUX_H
#define INCLUDE_AUTOINPUT_LINUX_INTERNAL_DATA_LINUX_H
#pragma once
...
#endif // INCLUDE_AUTOINPUT_LINUX_INTERNAL_DATA_LINUX_H
